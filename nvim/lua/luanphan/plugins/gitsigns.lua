    ...
    config   = function()
      ...
      gitsigns.setup({
        on_attach                    = function(bufnr)
          ...
          end, { desc = "Gitsigns: next hunk (or ]c in diff)" })
          ...
          end, { desc = "Gitsigns: previous hunk (or [c in diff)" })
          ...
          map("n", "<leader>hq", gitsigns.setqflist, { desc = "Gitsigns: quickfix buffer hunks" })
          ...
          -- Text object
          map({ "o", "x" }, "ih", gitsigns.select_hunk, { desc = "Gitsigns: inner hunk" })
        end,
        signs                        = {
          add          = { text = '┃' },
          change       = { text = '┃' },
